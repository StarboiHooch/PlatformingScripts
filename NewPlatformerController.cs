...
namespace Assets.Modules.PlatformingScripts
{
    public partial class NewPlatformerController : MonoBehaviour
    {
        ...
        private void ProcessWallJump()
        {
            ...
            {
                jumpPerformed = false;
                if (IsWallSliding || wallCoyoteTimer < wallCoyoteTime)
                {
                    isWallJumping = true;
        ...
        private bool CheckIfWallSliding()
        {
            ...
            return !isGrounded && !isRising && ((isTouchingWhichWall == WallCheckResult.Left && (movementInput.x < 0))
        ...
        private void Update()
        {
            ...
            isWallSliding = wallSlideEnabled ? CheckIfWallSliding() : false;
        ...
        private void FixedUpdate()
        {
            ...
            rb.gravityScale = isDashing || isWallSliding ? 0f : isRising ? gravityScaleRising : gravityScaleFalling;
            ...
            {
                if (isWallSliding || (wallCoyoteTimer < wallCoyoteTime && !isGrounded && !isRising))
                {
                    isWallJumping = true;
                }
                else
